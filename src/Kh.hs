...
-- | Determine if the component is non-trivial.
...
-- | Take two diagrams and returns the morphisms between them, if there is one.  
...
-- | Take a morphism and two generators and returns True if there should be an edge from one to the other.
